                ...
                <div class="card card-outline card-primary">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <select name="consultorio_id" id="consultorio_select_horarios" class="form-control">
                    ...
                    <div class="card-body">
                        <script>
                            ...
                            $('#consultorio_select_horarios').on('change', function() {
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <select name="doctor_id" id="doctor_select" class="form-control">
                                    <option value="">Selecciona su doctor</option>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" id="fecha_reserva" value="{{ now()->format('Y-m-d') }}" name="fecha_reserva" class="form-control">
                                                            <script>
                                                            ...
                                                            <script>
                                                                document.addEventListener('DOMContentLoaded', function() {
                                                                    ...
                                                                    horaReservaInput.addEventListener('change', function() {
                                                                        ...
                                                                        if (selectedTime) {
                                                                            selectedTime = selectedTime.split(':'); //Dividir en horas y minutos
                                                                        ...
                                                                        if (selectedTime < '08:00' || selectedTime > '20:00') {
                                                                            //si es así, estabalecer la hora seleccionada en null
                                                                            this.value = null;
                                                                            alert('Por favor selecciona una hora entre las 08:00 y las 20:00.');
                                                                        }
                                                                    });
                                                                });
                                                            </script>
