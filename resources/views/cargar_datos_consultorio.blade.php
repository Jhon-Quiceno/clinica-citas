<div class="table-responsive">
    <h3><center><b>Horario de atención del consultorio {{ $consultorio->nombre }}</b></center></h3>
    <br>
    <table style="font-size: 12px; text-align:center" class="table table-striped table-hover table-sm table-bordered">
        <thead>
