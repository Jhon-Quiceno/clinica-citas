...
Route::get('/admin/horarios/doctores/consultorio/{id}', [App\Http\Controllers\HorarioController::class, 'cargar_doctores_consultorio'])->name('admin.horarios.cargar_doctores_consultorio')->middleware('auth');
