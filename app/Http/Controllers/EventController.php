...
class EventController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $dia = date('1', strtotime($fecha_reserva));
    ...
    public function destroy($id)
    {
        Event::destroy($id);
        return redirect()->back()->with([
            'mensaje' => 'Se eliminio la reserva de la manera correcta',
            'icono' => 'success',
        ]);
    }
...
//        $canvas->page_text(450, 800, "Fecha:".\Carbon\Carbon::now()->format("d/m/Y")."-
//        ".\Carbon\Carbon::now()->format('H:i:s'), null, 10, array(0, 0, 0));
//
//        return $pdf->stream();
//    }
//
